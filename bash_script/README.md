...
| **محیط تست** | ساختن یکイメージ Docker اوبونتو سفارشی برای تست ایزوله اسکریپت |
...
|
اسکریپت با موفقیت:
- ✅ میزان مصرف CPU را نمایش می‌دهد
- ✅ میزان مصرف RAM را گزارش می‌کند
- ✅ فضای دیسک را نشان می‌دهد
- ✅ Nginx را نصب می‌کند
- ✅ یک صفحه HTML ساده ایجاد می‌کند
- ✅ سرویس Nginx را راه‌اندازی می‌کند
